        ...
        <div class="container">
            <div class="page-title text-center">
                <div class="heading-holder">
                    <font color="#604935"><h1>Kontak Kami</h1></font> 
                </div>
                  <p class="lead">Jangan ragu untuk menghubungi kami!</p>  
            </div>
        </div>
      </div>
      <div class="section-kswntree">
        <div class="container">
                <div class="brand-kswn">
                    <div class="links">
                        <div class="link">
                            <a href="#" target="_blank" class="btn btn-link">
                                <img src="{{asset('style/button/1.png')}}" alt="Forest" width="300" height="300" class="img-responsive">
                            </a>
                            <a href="#" target="_blank" class="btn btn-link">
                                <img src="{{asset('style/button/2.png')}}" alt="Forest" width="300" height="52.9" class="img-responsive">
                            </a>
                            <a href="#" target="_blank" class="btn btn-link">
                                <img src="{{asset('style/button/3.png')}}" alt="Forest" width="300" height="52.9" class="img-responsive">
                            </a>
                            <a href="#" target="_blank" class="btn btn-link">
                                <img src="{{asset('style/button/4.png')}}" alt="Forest" width="300" height="52.9" class="img-responsive">
                            </a>
                        </div>
                    </div>
                </div>
